...
class Config(config_dict.ConfigDict):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.data_dir = "data/PIm0028"
        self.manual_seg_filepath = "" # "/home/smostafavi/XeGas/xenon-gas-exchange-consortium-main/data/scanfolder/mask_reg_edited.nii"
        ...
        self.registration_key = constants.RegistrationKey.SKIP.value # Skipping registration, why?
        self.bias_key = constants.BiasfieldKey.SKIP.value # constants.BiasfieldKey.N4ITK.value # Bias-field correction is not skipped # Haad: skipping for testing purposes
        self.hb_correction_key = constants.HbCorrectionKey.NONE.value
        self.hb = 0.0
        self.subject_id = "PIm0028"
        self.rbc_m_ratio = 0 #0.575
...
class Recon(object):
    ...
    def __init__(self):
        ...
        self.recon_proton = True # Haad: If True, the 1H_radial .dat file is used
